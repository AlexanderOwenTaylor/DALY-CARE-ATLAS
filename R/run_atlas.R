run_atlas <- function(project_root, source_map_path, output_root = "atlas_runs",
  ...
  payload_confluence_feasibility <- list(
    ...
    story_cards = safe_read_output_csv(output_paths$confluence_story_cards, confluence_feasibility$story_cards),
    evidence_spine = safe_read_output_csv(output_paths$confluence_evidence_spine, confluence_feasibility$evidence_spine),
    overlap_signal_summary = safe_read_output_csv(output_paths$confluence_overlap_signal_summary, confluence_feasibility$overlap_signal_summary),
    ingredient_map = safe_read_output_csv(output_paths$confluence_ingredient_map, confluence_feasibility$ingredient_map),
    protocol_runway = safe_read_output_csv(output_paths$confluence_protocol_runway, confluence_feasibility$protocol_runway),
    clone_route_manifest = safe_read_output_csv(output_paths$confluence_clone_route_manifest, confluence_feasibility$clone_route_manifest),
    clone_source_resolution = safe_read_output_csv(output_paths$confluence_clone_source_resolution, confluence_feasibility$clone_source_resolution),
    bcell_clone_evidence_counts = safe_read_output_csv(output_paths$confluence_bcell_clone_evidence_counts, confluence_feasibility$bcell_clone_evidence_counts),
    pcd_clone_evidence_counts = safe_read_output_csv(output_paths$confluence_pcd_clone_evidence_counts, confluence_feasibility$pcd_clone_evidence_counts),
    paraprotein_ambiguity_counts = safe_read_output_csv(output_paths$confluence_paraprotein_ambiguity_counts, confluence_feasibility$paraprotein_ambiguity_counts),
    mgus_reclassification_waterfall = safe_read_output_csv(output_paths$confluence_mgus_reclassification_waterfall, confluence_feasibility$mgus_reclassification_waterfall),
    dual_clone_overlap_counts = safe_read_output_csv(output_paths$confluence_dual_clone_overlap_counts, confluence_feasibility$dual_clone_overlap_counts),
    dual_clone_overlap_timing = safe_read_output_csv(output_paths$confluence_dual_clone_overlap_timing, confluence_feasibility$dual_clone_overlap_timing),
    primary_overlap_exclusion_reasons = safe_read_output_csv(output_paths$confluence_primary_overlap_exclusion_reasons, confluence_feasibility$primary_overlap_exclusion_reasons),
    clone_availability_protocol_runway = safe_read_output_csv(output_paths$confluence_clone_availability_protocol_runway, confluence_feasibility$clone_availability_protocol_runway),
  ...
  payload_smm_immunity_tracker <- list(
    ...
    tracker_status = safe_read_output_csv(output_paths$smm_immunity_tracker_tracker_status, smm_immunity_tracker$tracker_status),
...
output_manifest_artifact_metadata <- function(id, path = "") {
  ...
  smm_immunity_canonical <- c(
    ...
    "smm_immunity_tracker_tracker_status",
