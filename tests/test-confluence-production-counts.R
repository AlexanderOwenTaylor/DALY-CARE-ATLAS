...
expect_true(any(merged$story_cards$card_id == "overlap_identifiable" & merged$story_cards$headline == "Accepted dual-clone cohort route is available"), "Accepted production story copy should state that the accepted route is available.")
