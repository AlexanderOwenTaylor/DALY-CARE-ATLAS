...
for (needle in c("Start here — DALY-CARE internal briefing", "PI / senior investigator", "Data manager / QA", "Lymphoma researcher", "New employee onboarding", "Senior clinician / manager", "Internal briefing")) {
...
for (needle in c("height", "hoejde", "weight", "vaegt", "ryger", "rituximab", "mabthera", "patobank", "biobank", "pi briefing", "management overview", "chief doctor", "data manager", "source readiness", "feasibility", "mbl", "dd479b", "dd472", "overlap", "blood culture", "pcd", "mm", "mgus", "amyloidosis", "cll", "lymphoma", "not in database", "del17p")) {
